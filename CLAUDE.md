...
**ВАЖНО: Весь backend ведём на Rust. Новые фичи и сервисы пишем на Rust; Python допускается только для существующих legacy-скриптов, подлежащих переписыванию.**
