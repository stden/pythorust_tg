...
Remaining scripts to migrate: `chat_analysis`, `mcp_telegram_server.py`, `ai_project_consultant.py`, `sales_bot.py`, `credit_expert_bot.py`. Install deps: `uv sync`. Already migrated: `n8n_monitor.py`, `n8n_backup.py`.
