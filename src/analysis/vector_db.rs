...
mod tests {
    ...
    fn search_filter_chaining() {
        let filter = SearchFilter::new().chat(100).sender(200).outgoing(true);
    ...
    fn search_filter_negative_chat_id() {
        ...
        let filter = SearchFilter::new().chat(-1001);

        assert_eq!(filter.chat_id, Some(-1001));
    ...
    fn search_filter_chain_override() {
        let filter = SearchFilter::new().chat(1).chat(2).chat(3);
