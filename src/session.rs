...
mod tests {
    ...
    fn save_session_returns_ok() {
        // save_session is a no-op for SqliteSession, just verify it compiles and returns Ok
        // We can't easily test with a real SqliteSession without a database file
