...
/// Supports:
/// - Config name lookup (e.g., "chat_alpha")
/// - Direct numeric ID (e.g., "1001")
...
mod tests {
    ...
    fn resolve_chat_entity_handles_numeric_id() {
        ...
        let entity = resolve_chat_entity("1001", &config).unwrap();
        assert!(matches!(entity, ChatEntity::Chat(1001)));
    }
