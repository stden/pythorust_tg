...
//!
//! Usage:
//!   cargo run --bin ab_test_report -- --bot-name sales_bot --experiment sales_prompt_ab
...
use telegram_reader::mysql_async::Pool;
...
struct Args {
    ...
    #[arg(long, default_value = "sales_bot")]
    bot_name: String,

    /// Experiment name (experiment_name in bot_experiments)
    #[arg(
        long,
        env = "SALES_PROMPT_EXPERIMENT",
        default_value = "sales_prompt_ab"
    )]
    experiment: String,
