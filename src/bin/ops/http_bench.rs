//! HTTP Benchmark Tool (wrk analog).
//!
//! Simple and fast HTTP benchmark in Rust.
//!
//! Usage:
...
#[command(about = "HTTP benchmark utility (wrk analog)", long_about = None)]
struct Cli {
    /// URL to test.
    url: String,
