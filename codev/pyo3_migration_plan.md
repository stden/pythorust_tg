...
# Проверка телефона
has_phone = contains_phone("+7 999 123-45-67")
# -> True
...
messages = [
    MessageData(sender="Alice", text="Hello", date="10:00", reactions="🔥"),
    MessageData(sender="Bob", text="Hi!", date="10:01", reactions=None),
]
