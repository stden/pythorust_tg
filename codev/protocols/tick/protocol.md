...
3. **Update Architecture Documentation**:
   - Use architecture-documenter agent to update `docs/architecture.md`
   - Document new modules, utilities, or architectural changes
   - Ensure `docs/architecture.md` reflects current codebase state
4. **COMMIT**: "TICK Review: [descriptive-name]" (includes consultation findings and architecture-doc updates)
