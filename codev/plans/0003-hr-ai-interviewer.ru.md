...
> Связанная спецификация: `codev/specs/0003-hr-ai-interviewer.ru.md`  
...
## Артефакты
- Спецификация: `codev/specs/0003-hr-ai-interviewer.ru.md`
- План: `codev/plans/0003-hr-ai-interviewer.ru.md` (текущий документ)
- Ревью: `codev/reviews/0003-hr-ai-interviewer.ru.md` (создать после завершения)
