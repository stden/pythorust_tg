...
> Связанная спецификация: `codev/specs/0002-helpdesk-autopilot.ru.md`  
...
## Артефакты
- Спецификация: `codev/specs/0002-helpdesk-autopilot.ru.md`
- План: `codev/plans/0002-helpdesk-autopilot.ru.md` (текущий документ)
- Ревью: `codev/reviews/0002-helpdesk-autopilot.ru.md` (создать после завершения)
