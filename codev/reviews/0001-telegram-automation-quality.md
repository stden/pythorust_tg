...
- `raw_chat_export.md` contains raw chat log with user handles and media URLs; should be moved to private storage or redacted if kept in repo.
...
- Migrate or purge chat log dumps (`raw_chat_export.md` and similar) from the tracked repo; keep only sanitized samples.
