...
Analyzes recent messages from all chats and looks for:
- Action requests (@your_username, "do", "need", "must")
- Questions that require an answer
- Mentions of tasks, bugs, and problems
...
# My username for mention search.
MY_USERNAME = os.getenv("MY_NAME", "your_username")

# Keywords for task search.
TASK_KEYWORDS = [
    "сделай",
    "нужно",
    "надо",
