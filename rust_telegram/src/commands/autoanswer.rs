...
pub async fn run(model: &str) -> Result<()> {
    ...
    let api_key = std::env::var("OPENAI_API_KEY")
        .map_err(|_| Error::InvalidArgument("OPENAI_API_KEY environment variable not set".to_string()))?;
    ...
    let request = CreateChatCompletionRequest {
        ...
        messages: vec![
            ChatCompletionRequestMessage::System(ChatCompletionRequestSystemMessage {
                content: async_openai::types::ChatCompletionRequestSystemMessageContent::Text(SYSTEM_INSTRUCTIONS.to_string()),
                name: None,
            }),
            ChatCompletionRequestMessage::User(ChatCompletionRequestUserMessage {
                content: async_openai::types::ChatCompletionRequestUserMessageContent::Text(user_message.to_string()),
                name: None,
            }),
        ],
