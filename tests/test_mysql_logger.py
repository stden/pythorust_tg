...
def test_save_user(logger_with_mocks):
    ...
    user = SimpleNamespace(
        id=123, username="testuser", first_name="Test", last_name="User", lang_code="en", premium=True, bot=False
    )
...
def test_save_message(logger_with_mocks):
    ...
    logger.save_message(user_id=123, message_id=456, text="Hello", direction="incoming")
