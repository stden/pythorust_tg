...
class TestReadFunctionality:
    ...
    def chat_config(self, tmp_path):
        ...
        config = {"chats": {"test_chat": {"type": "channel", "id": 1234567890, "title": "Test Chat"}}}
    ...
    async def test_filter_messages_by_reactions(self, sample_messages):
        ...
        filtered = [
            msg for msg in sample_messages if msg.reactions and sum(r.count for r in msg.reactions.results) >= 100
        ]
    ...
    async def test_engagement_metrics(self, sample_messages):
        ...
        total_reactions = sum(sum(r.count for r in msg.reactions.results) for msg in sample_messages if msg.reactions)
