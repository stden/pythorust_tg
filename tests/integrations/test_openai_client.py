...
class TestOpenAIClient:
    ...
    def mock_openai(self):
        ...
        with patch("openai.OpenAI") as mock_class:
            ...
            client.audio.speech.create = MagicMock(
                return_value=MagicMock(content=b"audio_data")
            )
            
            # Mock moderations
            moderation_response = MagicMock()
            moderation_response.results = [MagicMock(
                flagged=False,
    ...
    def test_moderate_content(self, mock_openai):
        ...
        mock_openai.moderations.create.assert_called_once_with(
            input="Safe content"
        )
...
class TestModuleFunctions:
    ...
    def test_generate_speech_function(self, mock_client_class):
        ...
        mock_instance.generate_speech.assert_called_once_with(
            "Hello",
            voice="nova",
            speed=1.0
        )
