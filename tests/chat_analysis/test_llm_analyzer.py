...
def test_create_result(llm_analyzer):
    analysis_data = {
        ...
        "discussions": [{"title": "D1", "date": "2023-01-01", "participants": ["A"], "messages_count": 5, "summary": "S"}],
...
async def test_analyze_integration(llm_analyzer):
    ...
    with patch.object(llm_analyzer, "_load_default_prompt", return_value="Template"), \
