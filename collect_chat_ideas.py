#!/usr/bin/env python3
"""
Collect improvement ideas from all chats.

Analyzes recent chat messages and extracts:
...
async def main():
    ...
    parser.add_argument(
        "--chats", nargs="+", required=True, help="Чаты для анализа (например: @example_channel @another_channel)"
    )
