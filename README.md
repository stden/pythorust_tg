...
- Bots: Rust Sales Bot with MySQL logging and A/B prompts; legacy Python bots (Credit Expert, AI Project Consultant, Task Assistant) until they are migrated.
...
- Stack checklist: `TESTING_CHECKLIST_PYTHON.md`
