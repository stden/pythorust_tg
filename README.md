...
| Функция | Описание |
|---------|----------|
| 💬 **Умный автоответчик** | GPT-4 отвечает за вас, когда вы заняты |
...
# Опциональные
OPENAI_API_KEY=sk-...           # Для AI-автоответчика
LINEAR_API_KEY=lin_api_...      # Для Linear интеграции
```
...
│   │   ├── lightrag/        # 🧠 RAG для знаний (WIP)
│   │   ├── integrations/    # OpenAI, Ollama, Yandex TTS
